package com.springboot.backend.david.usersapp.users_backend.controllers;
...
import com.springboot.backend.david.usersapp.users_backend.services.UserService;
...
public class UserController {
    ...
    private ResponseEntity<?> validation(BindingResult result) {
        ...
        result.getFieldErrors().forEach(error->{
            errors.put(error.getField(),"The field" 
